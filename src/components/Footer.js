...
class Footer extends Component {
    ...
    render() {
        return (
            <footer className="bottom" style={{ position: "fixed", width: "100%", bottom: "0", zIndex: "999", backgroundColor: "black" }}>
                ...
                <MediaQuery maxWidth={800}>
                    <div style={{ height: "55px", padding: '0 0px' }}>
                        <MediaQuery minWidth={356}>
                            <p className="copyright2" style={{ marginBottom: '0px' }}>Copyright © 2023 MarginX. All Rights Reserved. Powered by Function X.</p>
                        </MediaQuery>
                        <MediaQuery maxWidth={355}>
                            <p className="copyright3" style={{ marginBottom: '0px' }}>Copyright © 2023 MarginX. All Rights Reserved. Powered by Function X.</p>
                        </MediaQuery>
                        ...
                        <p className="linkMobile rowS" style={{ marginBottom: '0px' }}>
                            <span className='footer-link-item'>
                                <a href="https://t.me/+GiT9MPWQaPU2ZGU9" style={{ cursor: 'pointer', marginRight: '25px' }} onClick={() => {
                                    window.open(`https://t.me/+GiT9MPWQaPU2ZGU9`, '_blank')
                                }}><img src={telegram} width="18" height="18" align="left" alt="" />
                                </a>
                            </span>
                            <span className='footer-link-item'>
                                <a href="https://www.youtube.com/channel/UCJ8ggaUjfS5at6_toTJM8yg" style={{ cursor: 'pointer', marginRight: '25px' }} onClick={() => {
                                    window.open(`https://www.youtube.com/channel/UCJ8ggaUjfS5at6_toTJM8yg`, '_blank')
                                }}><img src={youtube} width="18" height="18" align="left" alt="" />
                                </a>
                            </span>
                            <span className='footer-link-item'>
                                <a href="https://twitter.com/marginx_io" style={{ cursor: 'pointer', marginRight: '25px' }} onClick={() => {
                                    window.open(`https://twitter.com/marginx_io`, '_blank')
                                }}><img src={twitter} width="18" height="18" align="left" alt="" />
                                </a>
                            </span>
                            <span className='footer-link-item'>
                                <a href="https://discord.com/invite/7yUjqadZFq" style={{ cursor: 'pointer', marginRight: '25px' }} onClick={() => {
                                    window.open(`https://discord.com/invite/7yUjqadZFq`, '_blank')
                                }}><img src={discord} width="18" height="18" align="left" alt="" />
                                </a>
                            </span>
                            <span className='footer-link-item'>
                                <a href="https://github.com/marginxio" style={{ cursor: 'pointer', marginRight: '25px' }} onClick={() => {
